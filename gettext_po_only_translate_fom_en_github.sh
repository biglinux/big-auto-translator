...
#     done
    ...
    # Make en.po based in .pot
    msgen "$DIR/locale/$DIRNAME.pot" > "$DIR/locale/en.po"
    ...
    for i  in  $LANGUAGES; do    
        ...
        attranslate --srcFile=$DIR/locale/en.po --srcLng=en --srcFormat=po --targetFormat=po --service=azure --serviceConfig=$AZURE_KEY --targetFile=$DIR/locale/$i.po --targetLng=$i --overwriteOutdated=true
